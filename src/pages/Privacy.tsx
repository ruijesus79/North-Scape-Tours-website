                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                    ...
                    <div className="space-y-8 text-white/70 font-light leading-relaxed text-sm sm:text-base">
                        <section>
                            ...
                            <p>A entidade responsável pelo tratamento de dados é a "North Scape Tours" (NIPC: 518 190 145), com sede em Portugal. Comprometemo-nos com a proteção de dados pessoais, cumprindo estritamente as normativas do RGPD Europeu (Regulamento de Proteção de Dados de Caráter Pessoal).</p>
                        </section>
