                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                    ...
                    <div className="space-y-8 text-white/70 font-light leading-relaxed text-sm sm:text-base">
                        <section>
                            ...
                            <p>O serviço da "North Scape Tours" é operado em conformidade com as leis do estado Português, atuando como Agência de Animação Turística, com o número de registo RNAAT 284/2026. O nosso número fiscal (NIPC) é 518 190 145.</p>
                        </section>
